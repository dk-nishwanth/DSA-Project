    ...
    <div className="w-full space-y-4">
      ...
      <div className="flex flex-wrap gap-3 p-4 bg-muted/30 rounded-xl border">
        ...
        <Button 
          onClick={run} 
          disabled={isBusy}
          className={op === 'query' ? 'bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700' : 'bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700'}
        >
      ...
      {currentStep && (
        <div className="p-4 bg-muted/20 rounded-lg border shadow-inner">
          <div className="flex items-center gap-2">
      ...
      <div className="p-6 bg-gradient-visualization rounded-xl border-2 border-primary/20 space-y-4 shadow-lg">
        ...
        <div>
          ...
          <div className="flex gap-2 justify-center">
            {arr.map((x,i)=>(
              <div 
                key={i} 
                className={`px-3 py-2 border-2 rounded-lg bg-card font-mono text-sm min-w-[40px] text-center transition-all duration-300 ${
                  op === 'update' && parseInt(pos) === i ? 'border-amber-500 bg-amber-100 dark:bg-amber-900/30 shadow-glow-amber' : ''
                }`}
              >
        ...
        {/* Interactive Legend */}
        <div className="flex justify-center gap-4 text-xs mt-4 p-2 bg-card/50 rounded-lg">
